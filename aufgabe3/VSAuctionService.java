...
public interface VSAuctionService extends Remote
{
     ...
     *
     * @param auction The auction to register duration Time in seconds until the
     * auction ends handler The handler to notify when the auction has ended
     * @param duration
     * @param handler
     * @exception VSAuctionException if the duration is negative or an auction
     ...
     * @param price The bid
     * @param handler The handler to notify if another bid is placed that is
     * higher than this bid
     * @return <tt>true</tt> if the bid has been placed, otherwise
     * <tt>false</tt>
