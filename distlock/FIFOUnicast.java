...
public class FIFOUnicast extends Protocol {
	...
	public static class SimulatedUnicastProtocolHeader extends Header {
		...
		public Address getRealDestination() {
	...
	public Object down(Event evt) {
		...
		case Event.MSG:
			...
			if (m.getDest() != null) {
				...
				SimulatedUnicastProtocolHeader ph = new SimulatedUnicastProtocolHeader(
						m.getDest());
	...
	public Object up(Event evt) {
		...
		case Event.MSG:
			Message m = (Message) evt.getArg();
			SimulatedUnicastProtocolHeader ph = (SimulatedUnicastProtocolHeader) m
					.getHeader(SimulatedUnicastProtocolHeader.header_id);
			if (ph != null) {
				if (!ph.getRealDestination().equals(my_address))
					return null;
	...
	@Override
	public void init() {
		ClassConfigurator.add(SimulatedUnicastProtocolHeader.header_id,
